...
export const INITIAL_TABLES: Table[] = [
  { id: 't-1', name: 'Mesa 1', capacity: 2, status: 'available', x: 50, y: 50 },
  { id: 't-2', name: 'Mesa 2', capacity: 4, status: 'occupied', x: 200, y: 50 },
  { id: 't-3', name: 'Mesa 3', capacity: 4, status: 'available', x: 350, y: 50 },
  { id: 't-4', name: 'Mesa 4', capacity: 6, status: 'cleaning', x: 50, y: 200 },
  { id: 't-5', name: 'Mesa 5', capacity: 2, status: 'reserved', x: 200, y: 200 },
