export type View = 'DASHBOARD' | 'POS' | 'MENU' | 'TABLES' | 'REPORTS' | 'USERS' | 'KITCHEN' | 'WHATSAPP' | 'INVENTORY';
...
export interface User {
  id: string;
  username: string;
  password?: string; // Password should be handled securely, this is for simplicity
  role: Role;
}
